...
<div ng-controller="mainController">
    <div style="float:left; margin-bottom:20px;">
        <div>
          ...
          <span ng-click="targetData.isShowRoundAvg=false" ng-show="targetData.isShowRoundAvg && targetData.isShowRounds">Hide round avg</span>
          <span ng-click="targetData.isShowRoundAvg=true" ng-show="targetData.isShowRoundAvg == false && targetData.isShowRounds">Show round avg</span>
        </div>
